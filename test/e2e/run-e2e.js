...
async function run() {
  ...
  try {
    ...
    const advancedInitiallyCollapsed = await session.evaluate("Boolean(document.querySelector('[data-testid=\"manual-edit-toggle\"]'))")
    assert.equal(advancedInitiallyCollapsed, false, 'Advanced tools should stay collapsed for the first quick logs')
