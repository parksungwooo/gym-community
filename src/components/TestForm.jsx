      ...
      <div className="flex gap-4">
        {currentIndex > 0 && (
          <button
            ...
            className="flex-1 py-5 text-lg font-semibold border-2 border-gray-300 rounded-3xl hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
